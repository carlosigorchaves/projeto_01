...
-- Schema para Supabase (Postgres) — v2, com perfis de acesso
-- Rode isso inteiro no SQL Editor do seu projeto Supabase.
-- ============================================================

-- ---------- Perfis de acesso (o que cada nível pode fazer, por módulo) ----------
...
-- ---------- Usuários (ligados ao login do Supabase Auth) ----------
create table if not exists public.profiles (
  id uuid primary key references auth.users(id) on delete cascade,
  name text not null,
  email text not null,
  profile_id text not null default 'usuario-padrao' references public.access_profiles(id),
...
-- ============================================================
-- Perfis padrão (Administrador fixo + Usuário Padrão editável)
-- ============================================================
insert into public.access_profiles (id, name, locked, perms) values
  ('admin-full', 'Administrador', true,
   '{"painel":"view","lancamentos":"excluir","contratos":"excluir","usuarios":"excluir","config":"excluir"}'::jsonb),
  ('usuario-padrao', 'Usuário Padrão', false,
   '{"painel":"view","lancamentos":"edit","contratos":"view","usuarios":"none","config":"none"}'::jsonb)
on conflict (id) do nothing;

-- ============================================================
-- Perfil automático ao criar conta + primeiro usuário vira admin
-- ============================================================
...
as $$
begin
  insert into public.profiles (id, name, email, profile_id, active)
  values (
    new.id,
    coalesce(new.raw_user_meta_data->>'name', split_part(new.email, '@', 1)),
    new.email,
    case when (select count(*) from public.profiles) = 0 then 'admin-full' else 'usuario-padrao' end,
    true
  );
  return new;
end;
...
security definer set search_path = public
as $$
  select coalesce((select profile_id from public.profiles where id = auth.uid()) = 'admin-full', false);
$$;
...
-- access_profiles: todo autenticado lê; só admin cria/edita/apaga
drop policy if exists "access_profiles_select" on public.access_profiles;
create policy "access_profiles_select" on public.access_profiles for select
  using (auth.role() = 'authenticated');

drop policy if exists "access_profiles_write_admin" on public.access_profiles;
create policy "access_profiles_write_admin" on public.access_profiles for all
  using (public.is_admin()) with check (public.is_admin());

-- profiles: qualquer pessoa logada pode ver a lista (tela de Usuários);
-- só admin pode alterar perfil/status de alguém, ou remover o cadastro.
...
create policy "profiles_delete_admin_only" on public.profiles for delete
  using (public.is_admin());

-- demais tabelas: qualquer pessoa autenticada pode ler/gravar
-- (o controle fino de visualizar/editar/excluir é feito na tela,
-- conforme o perfil de acesso da pessoa)
...
insert into public.transactions (contract_id, tx_date, value, description, direction, label, code, manual_cat, cat, manual_item_code, item_code) values
('instituto-bahia', '2026-08-06', 2495900.0, 'REPASSE BAHIA ', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-06', 400000.0, 'REPASSE BAHIA ', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-06', 553395.05, 'FOLHA CLT PARTE 1', 'SAIDA', 'RH CLT', '1.01', NULL, 1, NULL, '1.01'),
('instituto-bahia', '2026-08-06', 110.5, 'TARIFA ', 'SAIDA', 'Despesa de Gestão', '5', NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-07', 15011.82, 'FOLHA CLT PARTE 2', 'SAIDA', 'RH CLT', '1.01', NULL, 1, NULL, '1.01'),
('instituto-bahia', '2026-08-07', 307894.5, 'ALIMENTAÇÃO ', 'SAIDA', 'Serviço', '4.01', NULL, 4, NULL, '4.01'),
('instituto-bahia', '2026-08-07', 4500.0, 'CLIMATIZAÇÃO ', 'SAIDA', 'Serviço', '4.17', NULL, 4, NULL, '4.17'),
('instituto-bahia', '2026-08-07', 6906.56, 'RADIOLOGIA ', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-07', 37800.0, 'FORTE VIGILANCIA ', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-07', 754967.05, 'SUPER FARMA ', 'SAIDA', 'Consumo ', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-07', 40000.0, 'MANAH SERVIÇOS MÉDICOS ', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-07', 18381.6, 'MANUTENÇÃO ', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-07', 12280.64, 'INTEEC', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-07', 13972.5, 'NORDESTE AMBIENTAL - RESIDUOS ', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-07', 124987.2, 'LABORATORIO - EUNALAB ', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-07', 55194.62, 'FOLHA CLT PARTE 3', 'SAIDA', 'RH CLT', NULL, NULL, 1, NULL, NULL),
('instituto-bahia', '2026-08-07', 5000.0, 'CREDITO POSTO DE GASOLINA ', 'SAIDA', 'Consumo ', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-07', 3526.45, 'SALDO DEVEDOR  POSTO DE GASOLINA ', 'SAIDA', 'Consumo ', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-07', 1686.69, 'PG CLT ROBSOJN PARTE 4', 'SAIDA', 'RH CLT', NULL, NULL, 1, NULL, NULL),
('instituto-bahia', '2026-08-07', 940284.82, 'POUPANÇA BAHIA ', 'SAIDA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-10', 940284.82, 'VOLTA PARA CORRENTE ', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-10', 327157.68, 'FOLHA DOS MÉDICOS PARTE 1', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-10', 1451.33, 'PASSAGEM DR HILDA ', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-10', 85140.12, 'DESPESAS BAHIA RATEIO ', 'SAIDA', 'consumo e despesa de gestão ', NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-10', 8.5, 'TARIFA ', 'SAIDA', 'consumo e despesa de gestão ', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-10', 12900.0, 'ALUGUEL DOS CARROS ', 'SAIDA', 'Locação de Veiculos ADM ', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-10', 8.5, 'TARIFA ', 'SAIDA', 'consumo e despesa de gestão ', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-10', 22745.84, 'OPME ', 'SAIDA', 'consumo', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-10', 8.5, 'TARIFA ', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-10', 15499.34, 'ENTRADA ELAINE ', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-11', 506389.19, 'TRANF POUPANÇA', 'SAIDA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-11', 2.5, 'TARIFA ', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-11', 506386.69, 'ENTRADA ', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-11', 189455.14, 'PAGAMENTO MÉDICOS PARTE 2', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-11', 6761.27, 'PAGAMENTO CLT PARTE 4', 'SAIDA', 'RH CLT', NULL, NULL, 1, NULL, NULL),
('instituto-bahia', '2026-08-11', 1200.0, 'CARRO PIPA', 'SAIDA', 'consumo', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-11', 6509.99, 'IMPRESSORAS', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-11', 19800.0, 'USINA DE OXIGENIO', 'SAIDA', 'Consumo', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-11', 2700.0, 'MANUTENÇÃO DE GERADORES', 'SAIDA', 'Serviço', NULL, NULL, 4, NULL, NULL),
('instituto-bahia', '2026-08-11', 4252.2, 'PRISCILLA ADM', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-11', 20000.0, 'KENYA JURIDICO', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-11', 15000.0, 'CONTABILIDADE', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-11', 15499.34, 'DR. ELLAINE SANTOS', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-11', 225208.75, 'TRANSF POUPANÇA ', 'SAIDA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-11', 2.5, 'TARIFA ', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-12', 225206.25, 'ENTRADA ISSL', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-12', 157520.47, 'PAGAMENTO MÉDICOS PARTE 3', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-12', 1122.35, 'PASTILHAS DE FREIO AMBULANCIA ', 'SAIDA', 'CONSUMO', NULL, NULL, 3, NULL, NULL),
('instituto-bahia', '2026-08-13', 30909.36, 'PAGAMENTO MÉDICOS PARTE 4', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-17', 2.27, 'JUROS', 'ENTRADA', 'Despesa de Gestão', NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-18', 4.81, 'JUROS', 'ENTRADA', 'Despesa de Gestão', NULL, NULL, NULL, NULL, NULL),
('instituto-bahia', '2026-08-18', 6105.5, 'APARTAMENTO * OCEANIA ', 'SAIDA', 'Despesa de Gestão', NULL, NULL, 5, NULL, NULL),
('instituto-bahia', '2026-08-18', 2064.7, 'PAGAMENTO MEDICO PARTE 4- FLAVIO FIGUEREDO ', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-18', 2064.7, 'PAGAMENTO MEDICO PARTE 4- FLAVIO FIGUEREDO ', 'SAIDA', 'RH MÉDICO ', NULL, NULL, 2, NULL, NULL),
('instituto-bahia', '2026-08-19', 3.73, 'juros ', 'ENTRADA', NULL, NULL, NULL, NULL, NULL, NULL);
